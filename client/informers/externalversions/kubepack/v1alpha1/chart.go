	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.KubepackV1alpha1().Charts(namespace).List(options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.KubepackV1alpha1().Charts(namespace).Watch(options)
			},
		},
		&kubepackv1alpha1.Chart{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *chartInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&kubepackv1alpha1.Chart{}, f.defaultInformer)
}
